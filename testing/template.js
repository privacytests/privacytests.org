...
const twitterDataURI = dataUriFromFile("./out/twitter.svg");
const githubDataURI = dataUriFromFile("./out/github.svg");
const emailDataURI = dataUriFromFile("./out/email.svg");
const logoDataURI = dataUriFromFile("./out/privacyTestsLogo.png");
