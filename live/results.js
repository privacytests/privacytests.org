...
// first party we use.
const firstPartyRootSame = 'https://test-pages.privacytests2.org';
const firstPartyRootDifferent = 'https://test-pages.privacytests.org';
...
const queryParameterTestUrl = (parameters) => {
  ...
  const baseURL = `${firstPartyRootDifferent}/query.html`;
...
const pageSequence = [
  `${firstPartyRootSame}/supercookies.html?mode=write&thirdparty=same`,
  `${firstPartyRootSame}/supercookies.html?mode=read&thirdparty=same`,
  `${firstPartyRootDifferent}/supercookies.html?mode=read&thirdparty=different`,
  `${firstPartyRootSame}/navigation.html?mode=write&thirdparty=same`,
  `${firstPartyRootSame}/navigation.html?mode=read&thirdparty=same`,
  `${firstPartyRootDifferent}/navigation.html?mode=read&thirdparty=different`,
  `${firstPartyRootSame}/fingerprinting.html`,
  `${firstPartyRootSame}/tracking_content.html`,
  `${firstPartyRootSame}/misc.html`,
  queryParameterTestUrl(TRACKING_QUERY_PARAMETERS),
  `${firstPartyRootSame}/https.html`,
  'http://upgradable.privacytests2.org/upgradable.html?source=hyperlink',
  //  `http://insecure.privacytests2.org/insecure.html`,
  `${firstPartyRootSame}/done.html`
];
