...
/usr/local/bin/node test config/desktop.yaml --except=safari --incognito --filename private
/usr/local/bin/node test --browser=safari --incognito --filename=private-safari
/usr/local/bin/node test --browser=brave --tor --repeat 5 --filename=brave-tor
/usr/local/bin/node test config/nightly.yaml
/usr/local/bin/node test config/nightly.yaml --incognito --filename nightly-private --except=safari,duckduckgo
/usr/local/bin/node test --browser=safari --incognito --nightly --filename=nightly-private-safari
