...
const dataUriFromFile = path => datauri(`${__dirname}/${path}`).content;
...
const twitterDataURI = dataUriFromFile("./images/twitter.svg");
const githubDataURI = dataUriFromFile("./images/github.svg");
const emailDataURI = dataUriFromFile("./images/email.svg");
const logoDataURI = dataUriFromFile("./images/privacyTestsLogo.png");
